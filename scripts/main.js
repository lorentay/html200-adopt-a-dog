document.addEventListener("DOMContentLoaded", () => {
  ...
  function addBlogPost(post) {
    ...
    img.classList.add("intro-image"); // Apply the existing CSS class
  ...
  // Loops through the array of new blog posts and adds them to the page
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener("submit", function (event) {
      ...
      const formData = {
        ...
        dogPreferences: Array.from(
          contactForm.querySelectorAll('input[name="dogPreference"]:checked')
      ...
      if (
        formData.contactReason === "adoption-information" &&
        formData.dogPreferences.length === 0
      ) {
      ...
      alert(
        "Thank you! We've received your information, and we will be in touch shortly."
      );
